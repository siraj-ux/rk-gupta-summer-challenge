      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex flex-col">
            {/* BAR TEXT UPDATED */}
            <span className="text-[11px] font-bold text-red-600 animate-pulse flex items-center gap-1 uppercase tracking-tight">
          ...
          <div className="flex flex-col items-center gap-1">
            <a href='#register'>
              <Button
                size="sm"
                onClick={onCTAClick}
                className="bg-[#003459] hover:bg-[#003459]/90 text-white flex items-center gap-1 px-4 h-9 text-xs font-bold"
              >
                {/* BUTTON TEXT UPDATED */}
                Join Now
