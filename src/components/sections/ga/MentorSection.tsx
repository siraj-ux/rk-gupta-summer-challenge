          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-shrink-0 mx-auto md:mx-0 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a 
                  href="https://www.youtube.com/@CryptowithRKGupta" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-xs font-bold text-[#003459] hover:text-[#007ea7] transition-colors"
                >
                  <Youtube className="h-4 w-4 text-red-600" /> YouTube
                </a>
                <a 
                  href="https://www.instagram.com/compoundthemoney/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-xs font-bold text-[#003459] hover:text-[#007ea7] transition-colors"
                >
                ...
                <a 
                  href="https://www.linkedin.com/in/ctm-rkgupt" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-xs font-bold text-[#003459] hover:text-[#007ea7] transition-colors"
                >
            ...
            <div className="flex-1">
              ...
              <div className="space-y-4 mb-8 text-[#00171f]/90 leading-relaxed text-left">
