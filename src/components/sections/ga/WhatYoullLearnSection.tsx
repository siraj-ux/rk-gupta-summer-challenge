    ...
    <section className="py-12 md:py-20 bg-[#003459] text-white">
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* CARD 1 - HOW IT WORKS */}
          <div className="bg-[#00171f] border border-[#007ea7]/40 rounded-2xl p-6 flex flex-col hover:border-[#00a8e8] transition-colors group">
            ...
            <ul className="space-y-4 text-sm text-white/85 flex-grow">
              <li className="flex gap-3">
                <BookOpen className="h-5 w-5 text-[#00a8e8] flex-shrink-0" /> 
                <span>Bitcoin, blockchain aur wallets ka basic structure</span>
              </li>
              <li className="flex gap-3">
                <Layers className="h-5 w-5 text-[#00a8e8] flex-shrink-0" /> 
                <span>Bina technical jargon ke, ek simple model ke saath</span>
              </li>
              <li className="flex gap-3">
                <HelpCircle className="h-5 w-5 text-[#00a8e8] flex-shrink-0" /> 
                <span>Digital assets ki real-world working clarity</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-[#007ea7] border border-[#00a8e8]/60 rounded-2xl p-6 flex flex-col hover:shadow-xl transition-shadow">
            ...
            <ul className="space-y-4 text-sm text-white/95 flex-grow">
              <li className="flex gap-3">
                ...
                <span>Common mistakes jo educated log bhi karte hain</span>
              </li>
              <li className="flex gap-3">
                <Brain className="h-5 w-5 text-white flex-shrink-0" /> 
                <span>Galat decisions ke peeche ka psychological reason</span>
              </li>
              <li className="flex gap-3">
                <Hourglass className="h-5 w-5 text-white flex-shrink-0" /> 
                <span>Hype aur FOMO ko identify karna seekhna</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-[#00171f] border border-[#007ea7]/40 rounded-2xl p-6 flex flex-col hover:border-[#00a8e8] transition-colors group">
            ...
            <ul className="space-y-4 text-sm text-white/85 flex-grow">
              <li className="flex gap-3">
                <MessageSquare className="h-5 w-5 text-[#00a8e8] flex-shrink-0" /> 
                <span>Bina kisi pe depend kiye khud judge karna</span>
              </li>
              <li className="flex gap-3">
                <Eye className="h-5 w-5 text-[#00a8e8] flex-shrink-0" /> 
                <span>News, claims ya opportunities ko filter karna</span>
              </li>
              <li className="flex gap-3">
                <ListOrdered className="h-5 w-5 text-[#00a8e8] flex-shrink-0" /> 
                <span>Self-dependent decision making framework</span>
              </li>
            </ul>
          </div>
        </div>
